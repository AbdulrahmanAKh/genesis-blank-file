  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-foreground mb-2">Comprehensive Admin Panel</h1>
          <p className="text-muted-foreground">Advanced management and comprehensive monitoring of Adrena platform</p>
        </div>
